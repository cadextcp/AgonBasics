...
1950   oldBY% = ballY%
1960   :
1970   REM --- Input (direkter Tastatur-Scan via INKEY(-N) ---
1975   REM   INKEY(-N) prueft intern FabGL-vkey (N-1). Klassische BBC-Micro-
1977   REM   Scancodes passen: A = -66, D = -51, ESC via INKEY(0) = 27.
1980   k% = INKEY(0)
1981   IF INKEY(-66) THEN padX% = padX% - padSpd%
1982   IF INKEY(-51) THEN padX% = padX% + padSpd%
